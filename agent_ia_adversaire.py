...
# Role : Attaquer les modeles IA du systeme ARMS
# ================================================================
...
if __name__ == "__main__":
    ...
    try:
        ...
        with open("rapport_ia_adversaire_brut.txt", "w", encoding="utf-8") as f:
            f.write(texte)
        print("Reponse brute sauvegardee -> rapport_ia_adversaire_brut.txt")